...
class Model
{
    ...
    {
        return [
            self::RULE_REQUIRED => 'Toto je povinné pole',
            self::RULE_EMAIL => 'Toto pole musí obsahovat platnou emailovou adresu',
            self::RULE_MIN => 'Toto pole musí obsahovat alespoň {min} znaků',
            self::RULE_MAX => 'Totopole musí obsahovat maximálně {max} znaků',
            self::RULE_MATCH => 'Toto pole musí být stejné jako {match}',
            self::RULE_UNIQUE => 'Zadaná hodnota již existuje',
        ];
    }
    ...
    public static function query($sql){
        return Application::$app->db->query($sql);
    }
